-- ==============================================================================
-- FIX: BREAKING RLS RECURSION
-- Problem: The previous Super Admin policy caused an infinite loop (SELECT on profiles -> Check Policy -> SELECT on profiles...).
-- Solution: Use a SECURITY DEFINER function to check status without triggering RLS.
-- ==============================================================================
...
-- 4. Re-Apply Team Policies just in case
